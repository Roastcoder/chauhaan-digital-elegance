    ...
    <footer className="bg-muted/30 border-t border-border">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground mb-2">
              ...
              B-5 A, Vaibhav Enclave, Near Indian Bank, Girdhar Marg, Malviya Nagar, Jaipur, Rajasthan 302017
            </div>
            ...
            <a href="tel:09376721157" className="flex items-center gap-2 text-xs text-primary hover:text-primary/80 transition-colors font-medium">
              <Phone className="w-3 h-3" />
              93767 21157 (Customer Support)
            </a>
              ...
              <div className="flex items-center gap-3 mt-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="w-9 h-9 rounded-full bg-foreground/5 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all duration-200"
                    title={link.platform}
                  >
                    {socialIcons[link.icon_name] || <span className="text-xs font-bold">{link.platform[0]?.toUpperCase()}</span>}
                  </a>
                ))}
              </div>
            )}
        ...
        <div className="border-t border-foreground/[0.05] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">© 2025 Chauhan Computers — B-5 A, Vaibhav Enclave, Malviya Nagar, Jaipur 302017</p>
